...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $dueAfterNotNull = collect($columns)->first(function ($column) {
            return $column->name === 'due_after' && $column->notnull === 1;
        });
        ...
        Schema::rename('reviews', 'reviews_tmp_nullable');
        ...
        $legacyReviews = DB::table('reviews_tmp_nullable')->get();
        ...
        Schema::drop('reviews_tmp_nullable');
    }
    ...
    {
        // no rollback; only normalizing legacy schema
    }
};
